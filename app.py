# -*- coding: utf-8 -*-
"""
AAMVA PDF417 50-State DL Generator (FINAL VERSION - SYNTAX FIX)
功能：生成符合 AAMVA D20-2020 标准的美国 50 州驾照 PDF417 条码。
特点：修复了 get_hex_dump_str 中的 SyntaxError。
"""
...
def pdf417_generator_ui():
    ...
    try:
        ...
        default_state_name = [name for name, abbr in jurisdictions.items() if abbr == "FK"][0]
    except IndexError:
